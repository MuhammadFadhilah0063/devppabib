...
<head>
    ...
    <title>LOGIN KOMPETENSI PPA</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 pt-0 fs-5">Masuk Ke Akun User</h5>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" method="POST" action="{{ url('login') }}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-control select2" id="jobsite" name="jobsite" required>
                                        ...
                                        <div class="col-12 mt-4 text-center">
                                            ...
                                            <small class="d-block pt-2">
                                                <a href="login/admin">Masuk sebagai admin</a>
                                            </small>
                                        </div>
                                    </form>
                                </div>
